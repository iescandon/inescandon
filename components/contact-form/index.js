...
function MyForm() {
  ...
  return (
    <form
      className="flex flex-col focus:outline-goldenrod"
    ...
    >
      ...
      ></textarea>
      <button
        className="self-end w-1/3 p-3 mt-10 text-black md:transition md:duration-200 md:ease-in-out md:hover:text-white md:hover:bg-coolBlue bg-goldenrod md:w-1/6 submit-btn"
        type="submit"
      ...
      {serverState.status && (
        <p
          className={`absolute rounded top-5 right-5 py-6 px-12 bg-black font-dawningOfaNewDay text-5xl text-white ${
