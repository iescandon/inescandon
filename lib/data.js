export const work = [
  {
    title: "Donate to a good cause in H-Town",
    name: "H Town for Humanity",
    slug: "htown-for-humanity",
    blurb:
      "A web/mobile Next.js app created pro bono for the non-profit H Town for Humanity. Users can learn about the non-profit, donate money or supplies, and reach out to them via the contact form. There is also a second 'hidden' page meant to provide help to refugees directly. Styled with Tailwind CSS. Mobile responsive.",
    description:
      "This application is a client-side application that was created pro bono for the non-profit H Town for Humanity. The user is presented with a visual story that explains what the non-profit does, how much of the donations are given to refugees, and images from H Town for Humanity's Instagram displaying evidence of the donation disbursement. Users can donate directly to the non-profit via a Donorbox integration which provide multiple payment method options or use the Formspree contact form to set up a cash/check/gift card or supply donation drop off. Additionally, there is a second page that is dedicated completely to refugees and providing them with answers to frequently asked questions. Because of the nature of the targeted users, this app is designed to be very mobile responsive and fully functional on even the smallest screens.",
    tools: ["next-js", "tailwind-css", "contentful-api", "instagram-basic-display-api"],
    github: "https://github.com/iescandon/htown-for-humanity",
    live_url: "https://www.htownforhumanity.org/",
    image: {
      src: "/images/htown-for-humanity.webp",
      alt: "H Town for Humanity web application screenshot",
      gif: "/gifs/htown-for-humanity.webm",
    },
  },
  {
    ...
    tools: ["react-js", "tailwind-css", "google-maps-api"],
  ...
  },
  {
    ...
    slug: "salud",
    blurb:
      "A full stack web app (MySQL, Express, Angular, Node.js) used to provide the user with a simple way to find a cocktail recipe. Allows user to search by name or filter by ingredients.",
    description:
