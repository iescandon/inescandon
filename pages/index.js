                ...
                <div className="container">
                  ...
                  <Link href={`/work/${item.slug}`}>
                    <div className="overlay rounded-md cursor-pointer">
                        ...
                        <div className="text rounded-md md:transition md:duration-200 md:ease-in-out text-white bg-coolBlue md:hover:text-black md:hover:bg-goldenrod">See More</div>
                    </div>
                    </div>
                  </Link>
                </div>
