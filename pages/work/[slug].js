        ...
        <section className="flex flex-col w-full ml-auto p-7 md:p-10 lg:w-9/12 lg:min-h-screen ">
          <div className="top-work">
            <div className="flex flex-row items-center mb-5">
              ...
              <a href={github} target="_blank" rel="noreferrer" tabIndex={-1}>
                <i
              ...
              <a href={live_url} target="_blank" rel="noreferrer" tabIndex={-1}>
                <i
            ...
            <img
              className="w-full mx-auto my-8 border rounded-md shadow-lg md:w-3/4 border-platinum lg:hidden"
              key={slug}
              src={image.src}
              alt={image.alt}
            ></img>
            <video
              className="hidden w-full mx-auto my-8 border rounded-md shadow-lg lg:block md:w-3/4 border-platinum"
              key={image.gif}
              loop
              autoPlay
              muted
            >
              <source src={image.gif} type="video/webm" />
              Sorry, your browser doesn&apos;t support embedded videos.
            </video>
            <div className="grid grid-cols-3 py-2 mb-8 md:flex md:flex-row md:flex-wrap md:justify-center">
              ...
              {tools.map((tool) => {
                return (
                  <img
                    ...
                    src={`/tools/${tool}.png`}
                    alt={`${tool} logo`}
                    className="place-self-center col-span-1 h-7 md:h-8 p-1 mx-3 lg:p-0.5 lg:mx-4"
                  />
                );
              })}
            </div>
            {/* <p className="mb-1 text-xl font-semibold uppercase lg:mb-2">Overview</p> */}
            <div>{description}</div>
          </div>
          <div className="relative mt-10 mb-5">
            <hr className="col-span-1 my-5 border-t-2 border-coolBlue md:col-span-2"></hr>
            <p className="absolute top-0 pr-2 mt-1.5 text-xl font-semibold uppercase bg-white">
              Other Work
            </p>
          </div>
          <SideMenu
